    ...
    public partial class _1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReparationInterventions", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReparationInterventions_Reparation_ReparationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReparationInterventions_ReparationId",
                table: "ReparationInterventions",
                column: "ReparationId");
        }
